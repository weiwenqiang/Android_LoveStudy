...
public class ListViewAdapter extends BaseListAdapter {
	
	List<String> list;

	@SuppressWarnings("unchecked")
	public ListViewAdapter(Context ctx, List<?> list) {
		super(ctx, list);
	...
	public View getViewNew(int position, View view, ViewGroup parent) {
		...
		imageView.setLayoutParams(DynamicSetViewSize.getInstance().getLayoutParamsImageView(imageView, LayoutParams.MATCH_PARENT, 900));
