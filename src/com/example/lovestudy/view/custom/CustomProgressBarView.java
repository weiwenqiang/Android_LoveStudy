...
public class CustomProgressBarView extends LinearLayout {
	...
	public enum Mode {
		ONESHOT, DETERMINATE, INDETERMINATE
	};
	...
	public void bar_config(int width, int height, int radius, int background_color, int[] progress_colors) {
		BAR_SIZE_W = width;
		BAR_SIZE_H = height;
		BAR_CORNER = radius;
		...
		switch (BAR_SIZE_W) {
		case 0:
			limits_params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FILL_PARENT, BAR_SIZE_H);
			break;
		default:
			limits_params = new LinearLayout.LayoutParams(BAR_SIZE_W, BAR_SIZE_H);
			break;
		}
		limits.setLayoutParams(limits_params);
		limits.setBackgroundColor(BAR_BACKGROUND);
		LinearLayout.LayoutParams bar_params = new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.FILL_PARENT);
	...
	public synchronized void animation_stop() {
		...
		LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(0, BAR_SIZE_H);
		bar.setLayoutParams(params);
	}
