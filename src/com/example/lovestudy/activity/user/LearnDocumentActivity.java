...
public class LearnDocumentActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_user_learn_document);
		setHeadTitle(R.string.learn_document);
		initView();
		bindData();
		bindView();
	}
	...
	private void bindData() {
		mapHint.put("0", getResources().getString(R.string.sqlite_grammar));
		mapClass.put("0", SQLiteGrammarActivity.class);
