...
public class InterfaceCallBackActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_user_interface_callback);
		setHeadTitle(R.string.interface_callback);
		initView();
		bindData();
		bindView();
	}
	...
	private void bindData() {
		mapHint.put("0", ResourcesGet.getString(ctx, R.string.interface_callback_download_data));
		mapClass.put("0", InterfaceCallBackDownloadDataActivity.class);

		mapHint.put("1", ResourcesGet.getString(ctx, R.string.interface_callback_display_dialog));
		mapClass.put("1", InterfaceCallBackDisplayDialogActivity.class);
