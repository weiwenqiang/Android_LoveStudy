...
public class LifeTrafficActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_user_life_traffic);
		setHeadTitle(R.string.traffic);
		initView();
		bindData();
		bindView();
	}
	...
	private void bindData() {
		mapHint.put("0", getResources().getString(R.string.how_to_handle_passport));
		mapClass.put("0", HandlePassportActivity.class);
