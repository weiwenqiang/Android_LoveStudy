...
import com.example.lovestudy.adapter.ListViewAdapter;
import com.example.lovestudy.base.BaseActivity;
import com.example.lovestudy.base.BaseListView;
import com.example.lovestudy.constant.Urls;

public class ListViewWidgetActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_widget_listview_widget);
		setHeadTitle(R.string.ListView);
		initView();
	}
